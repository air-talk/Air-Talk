	    ...
	    <div class="container">
		    ...
		    <div class="col-md-12">
		        <div class="well">
		        	...
		        	<p>{{ Form::radio('value', $question->right_answer ) }}{{$question->right_answer}}</p>
		        	<p>{{ Form::radio('value', $question->wrong_answer1 ) }}{{$question->wrong_answer1}}</p>
		        	<p>{{ Form::radio('value', $question->wrong_answer2 ) }}{{$question->wrong_answer2}}</p>
		        	<p>{{ Form::radio('value', $question->wrong_answer3 ) }}{{$question->wrong_answer3}}</p>
	...
	<script>
		$(function(){
		    $("#check").click(function() {
		    	...
		    	if(value == <?php echo $question->right_answer?>){
