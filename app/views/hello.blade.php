                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>Non-towered</h2>
                            <hr class="star-primary">
                            <img src="/images/windsock.png" class="img-responsive img-centered" alt="">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>Class D</h2>
                            <hr class="star-primary">
                            <img src="/images/singleprop.png" class="img-responsive img-centered" alt="">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>Class C</h2>
                            <hr class="star-primary">
                            <img src="/images/radar.png" class="img-responsive img-centered" alt="">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>Class B</h2>
                            <hr class="star-primary">
                            <img src="/images/airbus.png" class="img-responsive img-centered" alt="">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <hr class="star-primary">
                            <img src="/images/airtower.png" class="img-responsive img-centered" alt="">
                            <p>Use flashcards to learn the vocabulary that air traffic control may use.</p>
                            <ul class="list-inline item-details">
                            </ul>
                            <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fa fa-times"></i> Close</button>
                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>Aircraft Recognition</h2>
                            <hr class="star-primary">
                            <img src="/images/air_balloon.png" class="img-responsive img-centered" alt="">
                            <p>Use flashcards so that you will be able to recognize the aircraft in the sky with you.</p>
                            <ul class="list-inline item-details">
                            </ul>
                            <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fa fa-times"></i> Close</button>
                        </div>
